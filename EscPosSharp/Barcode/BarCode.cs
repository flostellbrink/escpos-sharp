...
public class BarCode : EscPosConst, BarCodeWrapperInterface
{
    ...
    public class BarCodeSystem
    {
        ...
        public static BarCodeSystem UPCE_A = new(1, "^\\d{6}$|^0{1}\\d{6,7}$|^0{1}\\d{10,11}$");
        public static BarCodeSystem UPCE_B = new(66, "^\\d{6}$|^0{1}\\d{6,7}$|^0{1}\\d{10,11}$");
        ...
        public static BarCodeSystem CODE39_A = new(4, "^[\\d\\p{Upper}\\ \\$\\%\\*\\+\\-\\.\\/]+$");
        public static BarCodeSystem CODE39_B =
            new(69, "^[\\d\\p{Upper}\\ \\$\\%\\*\\+\\-\\.\\/]+$");
        public static BarCodeSystem ITF_A = new(5, "^([\\d]{2})+$");
        public static BarCodeSystem ITF_B = new(70, "^([\\d]{2})+$");
        public static BarCodeSystem CODABAR_A =
            new(6, "^[A-Da-d][\\d\\$\\+\\-\\.\\/\\:]*[A-Da-d]$");
        public static BarCodeSystem CODABAR_B =
            new(71, "^[A-Da-d][\\d\\$\\+\\-\\.\\/\\:]*[A-Da-d]$");
