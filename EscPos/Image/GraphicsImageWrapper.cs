namespace EscPosSharp.Image
{
    ...
    /// </summary>
    public class GraphicsImageWrapper : EscPosConst, ImageWrapperInterface<GraphicsImageWrapper>
    {
        /// <summary>
        ...
        public virtual GraphicsImageWrapper SetJustification(Justification justification)
        {
        ...
        public virtual GraphicsImageWrapper SetGraphicsImageBxBy(
        ...
        public virtual byte[] GetBytes(EscPosImage image)
        {
            ...
            // write bytes
            image.GetRasterBytes().CopyTo(bytes);
